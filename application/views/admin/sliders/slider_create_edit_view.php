	...
	<div class='box-body'>
        ...
        ?>
              ...
              <label for="inputEmail3" class="control-label"><?=lang("Headline")?></label>
                ...
                <?=form_input('relation[translation]['.$lang['slug'].'][content][headline]',value(isset($item->content[$lang['slug']]->headline)?$item->content[$lang['slug']]->headline:""),
            ...
            <div class='form-group'>
              ...
              <label for="" class="control-label"><?=lang("Button text")?></label>
                ...
                <?=form_input('relation[translation]['.$lang['slug'].'][content][button_text]',value(isset($item->content[$lang['slug']]->button_text)?$item->content[$lang['slug']]->button_text:""),
								array('id'=>$lang['slug'].'_slug','class'=>'form-control editor cke_editable cke_editable_inline cke_contents_ltr cke_show_borders','placeholder'=>lang("link")))?>
						</div>
