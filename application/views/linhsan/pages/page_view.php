        ...
        <div class="latest-news-area">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Content End Here -->
                    <?=$this->load->view($template.'/elements/modules/m_left_sidebar',array('show_page_category'=>$this->load->view($template.'/elements/modules/pages/m_page_categories','',TRUE)))?>
