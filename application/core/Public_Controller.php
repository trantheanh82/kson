...
class Public_Controller extends MY_Controller{
	...
	function __construct(){
		...
		$this->data['before_head'] .= '<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v8.0&appId=219994525426954"></script>';
