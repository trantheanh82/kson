(function($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='/' class='logo-mobile-menu'><img src='/assets/upload/img/linhsan_logo_mobile.jpg' class='img-responsive' /></a>" });
  ...
  ***************************************/
    ...
    /*Event for select languages*/
    $('#language_selector').on('changed.bs.select', function (e, clickedIndex, isSelected, previousValue) {
