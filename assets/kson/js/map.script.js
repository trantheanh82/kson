...
//  google map 2 function custom ========================== //
	...
	if(jQuery('#gmap_canvas2').length){
		function init_map2() {
			var myOptions = {
				zoom: 16,
				center: new google.maps.LatLng(10.338300, 107.080910),
			...
			marker2 = new google.maps.Marker({
				map: map2,
				position: new google.maps.LatLng(10.338300, 107.080910),
				optimized: false,
				icon: new google.maps.MarkerImage('/assets/kson/images/marker.png')
			});
	...
	if(jQuery('#gmap_canvas4').length){
		function init_map4() {
			...
			marker4 = new google.maps.Marker({
				...
				optimized: false,
				icon: new google.maps.MarkerImage('/asset/kson/images/marker2.png')
			});
